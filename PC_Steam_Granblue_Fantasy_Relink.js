...
ui.options = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: "CharacterCommandListSupportSkillInfo", text: "CharacterCommandListSupportSkillInfo" },
      { value: "CharacterCommandListSupportSkillName", text: "CharacterCommandListSupportSkillName" },
      ...
      { value: "LyriaJournalFieldNoteCharacterInfo", text: "LyriaJournalFieldNoteCharacterInfo" },
      { value: "LyriaJournalFieldNoteCharacterName", text: "LyriaJournalFieldNoteCharacterName" },
      { value: "LyriaJournalFieldNoteFoeInfo", text: "LyriaJournalFieldNoteFoeInfo" },
      { value: "LyriaJournalFieldNoteFoeName", text: "LyriaJournalFieldNoteFoeName" },
      { value: "LyriaJournalFieldNoteTreasureInfo", text: "LyriaJournalFieldNoteTreasureInfo" },
      { value: "LyriaJournalFieldNoteTreasureName", text: "LyriaJournalFieldNoteTreasureName" },
      { value: "LyriaJournalFieldNoteWeaponInfo", text: "LyriaJournalFieldNoteWeaponInfo" },
      { value: "LyriaJournalFieldNoteWeaponName", text: "LyriaJournalFieldNoteWeaponName" },
      { value: "LyriaJournalFieldNoteWrightstoneInfo", text: "LyriaJournalFieldNoteWrightstoneInfo" },
      { value: "LyriaJournalFieldNoteWrightstoneName", text: "LyriaJournalFieldNoteWrightstoneName" },
      { value: "LyriaJournalMainStoryChapterName", text: "LyriaJournalMainStoryChapterName" },
      { value: "LyriaJournalMainStoryPartInfo", text: "LyriaJournalMainStoryPartInfo" },
      { value: "LyriaJournalMainStoryPartName", text: "LyriaJournalMainStoryPartName" },
  ...
  },
  {
    ...
    multiple: true,
    options: [
      { value: "CutsceneChapterTitle", text: "CutsceneChapterTitle", selected: true },
      { value: "CutsceneDialogueName", text: "CutsceneDialogueName", selected: true },
      { value: "CutsceneDialogueText", text: "CutsceneDialogueText", selected: true },
      { value: "CutsceneCenterText", text: "CutsceneCenterText", selected: true },
      { value: "OverworldAreaName", text: "OverworldAreaName", selected: true },
      { value: "OverworldDialogueName", text: "OverworldDialogueName", selected: true },
      { value: "OverworldDialogueText", text: "OverworldDialogueText", selected: true },
      { value: "OverworldDialogueChoice", text: "OverworldDialogueChoice", selected: true },
  ...
  },
  {
    ...
    multiple: true,
    options: [
      { value: "OverworldNPCDialogueText", text: "OverworldNPCDialogueText", selected: true },
      ...
      { value: "LoadingScreenTitle", text: "LoadingScreenTitle", selected: true },
  ...
  },
  {
    ...
    options: [
      ...
      { value: "CharacterCommandListSupportSkillName", text: "CharacterCommandListSupportSkillName", selected: true },
      { value: "CharacterCommandListSupportSkillInfo", text: "CharacterCommandListSupportSkillInfo", selected: true },
      ...
      { value: "MasterySkillInfo", text: "MasterySkillInfo", selected: true },
      { value: "InventoryItemInfo", text: "InventoryItemInfo", selected: true },
      { value: "InventoryWeaponName", text: "InventoryWeaponName", selected: true },
      { value: "InventoryWeaponInfo", text: "InventoryWeaponInfo", selected: true },
  ...
  },
  {
    ...
    multiple: true,
    options: [
      { value: "LyriaJournalMainStoryChapterName", text: "LyriaJournalMainStoryChapterName", selected: true },
      { value: "LyriaJournalMainStoryPartName", text: "LyriaJournalMainStoryPartName", selected: true },
      { value: "LyriaJournalMainStoryPartInfo", text: "LyriaJournalMainStoryPartInfo", selected: true },
      { value: "LyriaJournalFieldNoteCharacterName", text: "LyriaJournalFieldNoteCharacterName", selected: true },
      { value: "LyriaJournalFieldNoteCharacterInfo", text: "LyriaJournalFieldNoteCharacterInfo", selected: true },
      { value: "LyriaJournalFieldNoteFoeName", text: "LyriaJournalFieldNoteFoeName", selected: true },
      { value: "LyriaJournalFieldNoteFoeInfo", text: "LyriaJournalFieldNoteFoeInfo", selected: true },
      { value: "LyriaJournalFieldNoteWeaponName", text: "LyriaJournalFieldNoteWeaponName", selected: true },
      { value: "LyriaJournalFieldNoteWeaponInfo", text: "LyriaJournalFieldNoteWeaponInfo", selected: true },
      { value: "LyriaJournalFieldNoteTreasureName", text: "LyriaJournalFieldNoteTreasureName", selected: true },
      { value: "LyriaJournalFieldNoteTreasureInfo", text: "LyriaJournalFieldNoteTreasureInfo", selected: true },
      { value: "LyriaJournalFieldNoteWrightstoneName", text: "LyriaJournalFieldNoteWrightstoneName", selected: true },
      { value: "LyriaJournalFieldNoteWrightstoneInfo", text: "LyriaJournalFieldNoteWrightstoneInfo", selected: true },
      { value: "LyriaJournalDocumentName1", text: "LyriaJournalDocumentName1", selected: true },
      { value: "LyriaJournalDocumentInfo1", text: "LyriaJournalDocumentInfo1", selected: true },
      { value: "LyriaJournalDocumentName2", text: "LyriaJournalDocumentName2", selected: true },
      { value: "LyriaJournalDocumentInfo2", text: "LyriaJournalDocumentInfo2", selected: true },
      { value: "LyriaJournalDocumentInfo3", text: "LyriaJournalDocumentInfo3", selected: true },
      { value: "LyriaJournalTipName1", text: "LyriaJournalTipName1", selected: true },
      { value: "LyriaJournalTipInfo1", text: "LyriaJournalTipInfo1", selected: true },
      { value: "LyriaJournalTipName2", text: "LyriaJournalTipName2", selected: true },
      { value: "LyriaJournalTipInfo2", text: "LyriaJournalTipInfo2", selected: true },
      { value: "LyriaJournalTrophyName", text: "LyriaJournalTrophyName", selected: true },
      { value: "LyriaJournalTrophyInfo", text: "LyriaJournalTrophyInfo", selected: true },
