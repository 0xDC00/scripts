...
// @version      1.00
// @author       KaoKao (based on DC's script)
...
`.split(/\r?\n/).filter(i => i);
    ...
    const charset = (
        ...
        '侮撫武舞葡部封楓風伏副復幅服福腹複覆淵弗沸物分吻噴憤扮奮粉紛文聞兵幣平弊柄並蔽閉米頁壁癖別瞥蔑偏変乒篇編返遍便勉弁鞭保鋪捕補輔募' + // 36 8900-893F
        ...
        '例冷鈴零麗歷列劣烈裂廉憐漣簾練聯蓮連魯路露廊弄朗浪漏牢狠老郎六麓錄論和話歪惑蕨碗腕丼乖乘亂豫舒亞仍仗估佛佇侈佩佯來侖儘俘俐倚倡俯' + // 41 8A40-8A7F
